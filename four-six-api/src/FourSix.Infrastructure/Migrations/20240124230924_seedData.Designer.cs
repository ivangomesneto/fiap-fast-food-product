...
namespace FourSix.Infrastructure.Migrations
{
    ...
    [Migration("20240124230924_seedData")]
            ...
            modelBuilder.Entity("FourSix.Domain.Entities.PedidoAggregate.Pedido", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DataPedido = new DateTime(2024, 1, 24, 15, 9, 24, 251, DateTimeKind.Local).AddTicks(2926),
                            NumeroPedido = 1,
                            StatusId = (short)1
                        });
                });
            ...
            modelBuilder.Entity("FourSix.Domain.Entities.PedidoAggregate.PedidoCheckout", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Sequencia = 0,
                            DataStatus = new DateTime(2024, 1, 24, 15, 9, 24, 251, DateTimeKind.Local).AddTicks(2926),
                            StatusId = (short)1
                        });
                });
